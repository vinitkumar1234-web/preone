 const DEFAULT_SUPABASE_URL = "https://xgsdibpicfzkgqftagib.supabase.co";
const DEFAULT_SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhnc2RpYnBpY2Z6a2dxZnRhZ2liIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODU3NDM4NzMsImV4cCI6MjEwMTMxOTg3M30.rYwvY4hBjtzAXBGMBEwkX_BOie6HbZPmlhEgqLZhVqg";
const DEFAULT_RPC_NAME = "dashboard_json";
...
function getSupabaseConfig() {
    ...
    return {
        url: localStorage.getItem('supabase_url') || metaUrl || DEFAULT_SUPABASE_URL,
        key: localStorage.getItem('supabase_anon_key') || metaKey || DEFAULT_SUPABASE_ANON_KEY,
